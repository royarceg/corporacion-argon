        ...
        <div style={{ width: "100%", maxWidth: "420px", backgroundColor: "#ffffff", padding: "48px 40px" }}>
          ...
          {step === "form" ? (
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  ...
                  <input
                    ...
                    style={{ fontFamily: "Graphik, sans-serif", fontSize: "13px", color: "#000000", backgroundColor: "#ffffff", border: "1px solid rgba(0,0,0,0.2)", padding: "12px 14px", outline: "none", width: "100%", boxSizing: "border-box" }}
                  />
                </div>
              ...
              <p style={{ fontFamily: "Graphik, sans-serif", fontSize: "13px", color: "rgba(0,0,0,0.5)", margin: 0, textAlign: "center", lineHeight: 1.6 }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h1 style={{ fontFamily: "Graphik, sans-serif", fontSize: "20px", fontWeight: 400, color: "#000000", margin: "0 0 12px 0", letterSpacing: "-0.02em" }}>
                Enlace generado
              </h1>
              <p style={{ fontFamily: "Graphik, sans-serif", fontSize: "13px", color: "rgba(0,0,0,0.5)", lineHeight: 1.6, margin: "0 0 24px 0" }}>
              ...
              {resetLink && (
                <div style={{ backgroundColor: "#f5f4f4", padding: "16px", marginBottom: "24px", wordBreak: "break-all", textAlign: "left" }}>
                  <p style={{ fontFamily: "Graphik, sans-serif", fontSize: "11px", color: "rgba(0,0,0,0.45)", margin: "0 0 8px 0", textTransform: "uppercase", letterSpacing: "0.06em" }}>
                    Tu enlace de recuperación:
                  </p>
                  <a href={resetLink} style={{ fontFamily: "Graphik, sans-serif", fontSize: "12px", color: "#000", wordBreak: "break-all" }}>
                    {resetLink}
                  </a>
                </div>
              )}
              ...
              <a
                ...
                style={{ fontFamily: "Graphik, sans-serif", fontSize: "13px", fontWeight: 500, color: "#ffffff", backgroundColor: "#000000", textDecoration: "none", padding: "14px 32px", display: "inline-block", letterSpacing: "0.04em" }}
              >
                Continuar al Enlace
              </a>
            </div>
